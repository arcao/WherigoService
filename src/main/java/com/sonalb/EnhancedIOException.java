 ...
 * interface, and subclass of <code>java.io.IOException</code>.<p>
...
public class EnhancedIOException extends java.io.IOException implements IEnhancedException
{
	 ...
	 */
	public EnhancedIOException(String s)
	{
		super(s);
	}
	 ...
	 */
	public EnhancedIOException(Exception under)
	{
		super();
	 ...
	 * @see 	java.lang.Exception
	 */
	public EnhancedIOException(String s, Exception under)
	{
		super(s);
		setCausalException(under);
	}
	...
	/**
	 * Constructs an EnhancedIOException with a detail message, causal Exception, error code, 
	 ...
	 * @see 	java.lang.Exception
	 */
	public EnhancedIOException(String s, Exception under, String code, Object o, String method)
	{
		super(s);
		setCausalException(under);
		setCode(code);
	...
	/**
	 * Constructs an EnhancedIOException with an error code and, class and method of origin. For example,<br>
	 * <code>
	 * ...<br>
	 ...
	 * @param method	the method of origin.
	 */
	public EnhancedIOException(String code, Object o, String method)
	{
		super();
		setCode(code);
		setOriginClass(o);
	 ...
	 * @see 	java.lang.Exception
	 */
	public EnhancedIOException(String s, String code, Object o, String method)
	{
		super(s);
		setCode(code);
		setOriginClass(o);
	 ...
	 * is same as would be returned by <code>IOException.toString()</code>. 
	 ...
	 * </ul>
	 * 
	 * @return	the <code>String</code> representation of this <code>EnhancedIOException</code>.
