 ...
 * interface, and subclass of <code>RuntimeException</code>.<p>
...
public class EnhancedRuntimeException extends RuntimeException implements IEnhancedException
{
	 ...
	 */
	public EnhancedRuntimeException(String s)
	{
		super(s);
	}
	 ...
	 */
	public EnhancedRuntimeException(Exception under)
	{
		super();
	 ...
	 * @see 	java.lang.Exception
	 */
	public EnhancedRuntimeException(String s, Exception under)
	{
		super(s);
		setCausalException(under);
	}
	...
	/**
	 * Constructs an EnhancedRuntimeException with a detail message, causal Exception, error code, 
	 ...
	 * @see 	java.lang.Exception
	 */
	public EnhancedRuntimeException(String s, Exception under, String code, Object o, String method)
	{
		super(s);
		setCausalException(under);
		setCode(code);
	...
	/**
	 * Constructs an EnhancedRuntimeException with an error code and, class and method of origin. For example,<br>
	 * <code>
	 * ...<br>
	 ...
	 * @param method	the method of origin.
	 */
	public EnhancedRuntimeException(String code, Object o, String method)
	{
		super();
		setCode(code);
		setOriginClass(o);
	 ...
	 * @see 	java.lang.Exception
	 */
	public EnhancedRuntimeException(String s, String code, Object o, String method)
	{
		super(s);
		setCode(code);
		setOriginClass(o);
	 ...
	 * is same as would be returned by <code>RuntimeException.toString()</code>. 
	 ...
	 * </ul>
	 * 
	 * @return	the <code>String</code> representation of this <code>EnhancedRuntimeException</code>.
